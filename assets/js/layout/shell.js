(function () {
  ...
  var PROJECTS = [
    { slug: 'drone-battery', label: 'Drone Battery', href: '/projects/drone-battery/' },
    { slug: 'cvrp-ml', label: 'CVRP ML', href: '/projects/cvrp-ml/' },
    { slug: 'cal-transpo', label: 'Cal Transpo Ops', href: '/projects/cal-transpo/' },
    {
      slug: 'ca-college-going-cep',
      label: 'CA College-Going &amp; CEP',
      href: '/projects/ca-college-going-cep/',
    },
    { slug: 'wind-turbine', label: 'Wind Turbine', href: '/projects/wind-turbine/' },
    { slug: 'plane-boarding', label: 'Plane Boarding', href: '/projects/plane-boarding/' },
    { slug: '311-equity', label: '311 Equity', href: '/projects/311-equity/' },
    {
  ...
  var NAV_ITEMS = [
    {
      ...
      indicator:
        '<lottie-player src="/assets/img/icons/home.json" background="transparent" speed="0.8" style="width:40px;height:40px"></lottie-player>',
    },
    {
      key: 'projects',
      label: 'Projects',
    ...
    },
    {
      ...
      indicator:
        '<lottie-player src="/assets/img/icons/resume.json" background="transparent" speed="0.8" style="width:40px;height:40px"></lottie-player>',
    },
    {
      key: 'contact',
      label: 'Contact',
      ...
      indicator:
        '<lottie-player src="/assets/img/icons/contact.json" background="transparent" speed="0.8" style="width:40px;height:40px"></lottie-player>',
    },
  ];
  ...
  function renderFooter(currentPage) {
    var footerPrimaryText =
      currentPage === 'home'
        ? 'Last updated March 19, 2026 · Hosted on GitHub Pages.'
    ...
    return (
      ...
      footerPrimaryText +
      '</div>' +
      '<div id="footer-text"><small>Icons by <a href="https://lordicon.com/">Lordicon</a></small></div>'
    );
  }

  function bindLottieHover() {
